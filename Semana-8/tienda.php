                ...
                <form action  ="ticket.php" method="GET">
                    ...
                    <div class="input-field col 16" >
                        <select name="menu" id="menu-id">
                            ...
                            <option value="Cerveza">Cerveza $20</option>
                            <option value="Brandy">Brandy   $152</option>
                            <option value="Ginebra">Ginebra $200</option>
                            <option value="Cordiales">Cordiales  $300</option>
                            <option value="Mezcal">Mezcal   $350</option>
                            <option value="Tequila">Tequila $40</option>
                            <option value="Vodka">Vodka     $200</option>
                            <option value="Whiskey">Whiskey $700</option>
                        </select>
                    ...
                    <div class="input-field col s12" >
                      <textarea  id="textarea-id"  disabled  cols="100" rows="50" style="width = 875px; height: 317px" ></textarea>
                    </div>
                    <div class="input-field col 16">
                    ...
                    <div class="input-field col 16">
                        <button type="submit" class="btn waves-effect" id="Comprar-id">Comprar</button>
                    </div>
                </form>
            </div> <!-- ROW -->
        </div> <!-- CONTAINER -->
